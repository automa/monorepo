...
VALUES
  ...
  (3, 'codex', 'OpenAI''s coding agent', 'https://avatars.githubusercontent.com/u/14957082?s=64', 'manual', 'http://localhost:5007/hooks/automa', 'atma_whsec_codex', 'https://openai.com', NOW(), FALSE, FALSE, DEFAULT, DEFAULT),
  (4, 'claude-code', 'Anthropic''s coding agent', 'https://avatars.githubusercontent.com/u/76263028?s=64', 'manual', 'http://localhost:5008/hooks/automa', 'atma_whsec_claude-code', 'https://anthropic.com', NOW(), FALSE, FALSE, DEFAULT, DEFAULT),
  (5, 'aider', 'Open source coding agent', 'https://aider.chat/assets/icons/apple-touch-icon.png', 'manual', 'https://localhost:5009/hooks/automa', 'atma_whsec_aider', 'https://aider.chat', NOW(), FALSE, FALSE, DEFAULT, DEFAULT),
  (6, 'open-hands', 'All Hands'' coding agent', 'https://avatars.githubusercontent.com/u/169105795?s=64', 'manual', 'http://localhost:5010/hooks/automa', 'atma_whsec_open-hands', 'https://all-hands.dev', NOW(), FALSE, FALSE, DEFAULT, DEFAULT),
  (7, 'github-runners', 'Changes GitHub CI configuration to use Depot runners', 'https://depot.dev/assets/brand/1693758816/depot-icon-on-light.svg', 'scheduled', 'http://localhost:5004/hooks/automa', 'atma_whsec_github-runners', 'https://depot.dev', NOW(), TRUE, FALSE, ARRAY['.github/workflows'], ARRAY['.github/workflows']),
  (8, 'posthog', 'Adds code to track a new analytics event using Posthog', 'https://posthog.com/brand/posthog-logomark.svg', 'manual', 'http://localhost:5006/hooks/automa', 'atma_whsec_posthog', 'https://posthog.com', NOW(), FALSE, FALSE, DEFAULT, ARRAY['data']);
