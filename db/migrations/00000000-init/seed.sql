...
VALUES
  ...
  (2, NOW(), 1, 1, NULL, 'repo', '{}'),
  (2, NOW(), 1, NULL, 4, 'bot', '{}'),
  (2, NOW(), NULL, 1, 4, 'proposal', '{ "prId": 6, "prTitle": "Updated homepage headline", "prState": "closed", "prMerged": true, "prHead": "automa:automa/aider/2", "prBase": "master" }'),
  ...
  (5, NOW(), NULL, 1, 5, 'proposal', '{ "prId": 7, "prTitle": "Use runs-on managed runners for github actions", "prState": "closed", "prMerged": false, "prHead": "automa:automa/github-runners/5", "prBase": "master" }'),
  ...
  (6, NOW(), NULL, 1, 6, 'proposal', '{ "prId": 8, "prTitle": "Implemented tracking of \"User Login Attempted\" event", "prState": "open", "prMerged": false, "prHead": "automa:automa/posthog/6", "prBase": "master" }'),
