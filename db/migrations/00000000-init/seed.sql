...
INSERT INTO public.bots (org_id, name, short_description, image_url, description, type, webhook_url, webhook_secret, homepage, published_at, is_deterministic, is_preview, paths, draft_paths)
VALUES
  (1, 'automa', 'Updates & migrates automa settings', NULL, NULL, 'manual', 'https://localhost:5000/hooks/automa', 'atma_whsec_automa', 'https://automa.app', NULL, TRUE, FALSE, ARRAY['automa.json', 'automa.json5', '.github/automa.json', '.github/automa.json5'], ARRAY['automa.json', 'automa.json5', '.github/automa.json', '.github/automa.json5']),
  (1, 'dependency', 'Upgrade dependencies by updating code', NULL, NULL, 'scheduled', 'https://localhost:5001/hooks/automa', 'atma_whsec_dependency', 'https://dependency.bot', NULL, TRUE, TRUE, DEFAULT, DEFAULT),
  (1, 'refactor', 'Refactors your code according to your rules', NULL, NULL, 'manual', 'https://localhost:5002/hooks/automa', 'atma_whsec_refactor', 'https://refactor.bot', NULL, TRUE, FALSE, DEFAULT, DEFAULT),
...
VALUES
  ...
  (1, 'Running automa/github-runners on monorepo', TRUE, 'c', NOW(), 'skipped'),
...
VALUES
  ...
  (2, NOW(), NULL, 1, 4, NULL, 'proposal', '{ "prId": 106, "prNumber": 6, "prTitle": "Updated homepage headline", "prState": "closed", "prMerged": true, "prHead": "automa:automa/aider/2", "prBase": "master" }'),
  ...
  (5, NOW(), NULL, 1, 5, NULL, 'proposal', '{ "prId": 107, "prNumber": 7, "prTitle": "Use runs-on managed runners for github actions", "prState": "closed", "prMerged": false, "prHead": "automa:automa/github-runners/5", "prBase": "master" }'),
