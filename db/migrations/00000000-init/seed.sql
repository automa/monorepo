...
INSERT INTO public.task_items (task_id, created_at, actor_user_id, repo_id, bot_id, type, data)
VALUES
  (2, NOW(), 1, NULL, NULL, 'message', '{ "content": "Update the homepage headline" }'),
  (2, NOW(), 1, NULL, NULL, 'origin', '{ "orgId": 1 }'),
  (2, NOW(), 1, 1, NULL, 'repo', '{}'),
  (2, NOW(), 1, NULL, 4, 'bot', '{}'),
  (2, NOW(), NULL, 1, 4, 'proposal', '{ "prId": 106, "prNumber": 6, "prTitle": "Updated homepage headline", "prState": "closed", "prMerged": true, "prHead": "automa:automa/aider/2", "prBase": "master" }'),
  (3, NOW(), NULL, 1, NULL, 'repo', '{}'),
  (3, NOW(), NULL, NULL, 5, 'bot', '{}'),
  (4, NOW(), NULL, 1, NULL, 'repo', '{}'),
  (4, NOW(), NULL, NULL, 5, 'bot', '{}'),
  (5, NOW(), NULL, 1, NULL, 'repo', '{}'),
  (5, NOW(), NULL, NULL, 5, 'bot', '{}'),
  (5, NOW(), NULL, 1, 5, 'proposal', '{ "prId": 107, "prNumber": 7, "prTitle": "Use runs-on managed runners for github actions", "prState": "closed", "prMerged": false, "prHead": "automa:automa/github-runners/5", "prBase": "master" }'),
  (6, NOW(), NULL, NULL, NULL, 'message', '{ "content": "In `AuthLogin` component, when the user clicks on any of the login buttons, we want to send the \"User Login Attempted\" analytic event to track that the user has attempted a login." }'),
  (6, NOW(), NULL, NULL, NULL, 'origin', '{ "integration": "linear", "organizationId": "aa0479aa-f603-4508-8669-e283bca5a17f", "organizationName": "Automa", "teamId": "7b9f50fa-75b4-43bd-9a0a-0e0994f0ccd9", "teamKey": "DEMO", "teamName": "Demo", "userId": "db18fe9b-d550-44c5-816a-49ac71fccce9", "userName": "Pavan Sunkara", "userEmail": "pavan.sunkara@automa.app", "issueId": "cfb003a0-5c42-48da-b34e-ebbacb9282bb", "issueTitle": "Track \"User Logged In\" event", "issueIdentifier": "DEMO-11", "commentId": "661237eb-3f3d-4bb8-ad22-9245aff0a5d9" }'),
  (6, NOW(), NULL, 1, NULL, 'repo', '{}'),
  (6, NOW(), NULL, NULL, 6, 'bot', '{}'),
  (6, NOW(), NULL, 1, 6, 'proposal', '{ "prId": 108, "prNumber": 8, "prTitle": "Implemented tracking of \"User Login Attempted\" event", "prState": "open", "prMerged": false, "prHead": "automa:automa/posthog/6", "prBase": "master" }'),
  (7, NOW(), NULL, NULL, NULL, 'message', '{ "content": "In `AuthLogout` component, when the user clicks on the logout button, we want to send the \"User Logout Attempted\" analytic event to track that the user has attempted a logout." }'),
  (7, NOW(), NULL, NULL, NULL, 'origin', '{ "integration": "jira", "organizationId": "373e3aed-a60d-4a6d-9fd1-d136bc545eaa", "organizationUrl": "https://automa-demo.atlassian.net", "organizationName": "automa-demo", "projectId": "10000", "projectKey": "DEMO", "projectName": "Demo", "issuetypeId": "10002", "issuetypeName": "Task", "userId": "712020:3dd57004-4041-4aca-ab80-ced34cc711ab", "userName": "Pavan Sunkara", "userEmail": "pavan.sunkara@automa.app", "issueId": "10000", "issueTitle": "Track \"User Logged Out\" event", "issueKey": "DEMO-1", "commentId": "10040" }'),
  (7, NOW(), NULL, 1, NULL, 'repo', '{ "integration": "jira", "userId": "712020:3dd57004-4041-4aca-ab80-ced34cc711ab", "userName": "Pavan Sunkara", "userEmail": "pavan.sunkara@automa.app" }'),
  (7, NOW(), NULL, NULL, 6, 'bot', '{ "integration": "jira", "userId": "712020:3dd57004-4041-4aca-ab80-ced34cc711ab", "userName": "Pavan Sunkara", "userEmail": "pavan.sunkara@automa.app" }');
