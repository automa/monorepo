...
VALUES
  ...
  (2, NOW(), NULL, 'proposal', '{ "repoName": "monorepo", "repoOrgProviderName": "automa", "repoOrgProviderType": "github", "botName": "aider", "botImageUrl": "https://aider.chat/assets/icons/apple-touch-icon.png", "botOrgName": "automa", "prId": 6, "prTitle": "Updated homepage headline", "prState": "closed", "prMerged": true, "prHead": "automa:automa/aider/2", "prBase": "master" }'),
  ...
  (5, NOW(), NULL, 'proposal', '{ "repoName": "monorepo", "repoOrgProviderName": "automa", "repoOrgProviderType": "github", "botName": "github-runners", "botImageUrl": "https://depot.dev/assets/brand/1693758816/depot-icon-on-light.svg", "botOrgName": "automa", "prId": 7, "prTitle": "Use runs-on managed runners for github actions", "prState": "closed", "prMerged": false, "prHead": "automa:automa/github-runners/5", "prBase": "master" }'),
  ...
  (6, NOW(), NULL, 'proposal', '{ "repoName": "monorepo", "repoOrgProviderName": "automa", "repoOrgProviderType": "github", "botName": "posthog", "botImageUrl": "https://posthog.com/brand/posthog-logomark.svg", "botOrgName": "automa", "prId": 8, "prTitle": "Implemented tracking of \"User Login Attempted\" event", "prState": "open", "prMerged": false, "prHead": "automa:automa/posthog/6", "prBase": "master" }'),
