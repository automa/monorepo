...
export const NavList = tw(
  NavigationMenu.List,
)`flex flex-col font-medium leading-8 text-neutral-800 lg:flex-row lg:gap-6`;
...
export const MobileMenuOverlay = tw.div`fixed left-0 right-0 top-16 -z-40 scale-105 transform overflow-hidden bg-white opacity-0 shadow-sm transition-all duration-300 ease-in-out peer-checked:z-40 peer-checked:scale-100 peer-checked:opacity-100`;
