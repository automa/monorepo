...
export type OrgsQueryFragmentFragment = { __typename?: 'Query', orgs: Array<{ __typename?: 'Org', id: number, name: string, provider_type: ProviderType, has_installation: boolean }> } & { ' $fragmentName'?: 'OrgsQueryFragmentFragment' };
...
export type MeQueryFragmentFragment = { __typename?: 'Query', me: { __typename?: 'User', id: number, name: string, email: string } } & { ' $fragmentName'?: 'MeQueryFragmentFragment' };
