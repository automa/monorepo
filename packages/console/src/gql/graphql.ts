...
export type PublicBotFragmentFragment = { __typename?: 'PublicBot', id: number, name: string, short_description?: string | null, org: { __typename?: 'PublicOrg', name: string } } & { ' $fragmentName'?: 'PublicBotFragmentFragment' };
...
export type PublicBotsQueryVariables = Exact<{ [key: string]: never; }>;
