...
export type BotFragment = { __typename?: 'Bot', id: number, name: string, short_description: string, type: BotType, webhook_url: string, webhook_secret: string, draft_paths: Array<string>, image_url?: string | null, description?: string | null, homepage?: string | null, is_published: boolean, is_preview: boolean, is_deterministic: boolean } & { ' $fragmentName'?: 'BotFragment' };
