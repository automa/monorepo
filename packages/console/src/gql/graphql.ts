...
export type TaskFragmentFragment = { __typename?: 'Task', id: number, title: string, created_at: any, completed_at?: any | null, is_completed: boolean, author?: (
    { __typename?: 'User' }
    & { ' $fragmentRefs'?: { 'UserAvatarFragmentFragment': UserAvatarFragmentFragment } }
  ) | null, items: Array<{ __typename?: 'TaskItem', id: number, type: TaskItemType, data?: any | null, created_at: any }> } & { ' $fragmentName'?: 'TaskFragmentFragment' };
