...
type BotBase_Bot_Fragment = { __typename?: 'Bot', id: number, name: string, short_description: string, image_url?: string | null, type: BotType, is_published: boolean, is_preview: boolean, is_deterministic: boolean } & { ' $fragmentName'?: 'BotBase_Bot_Fragment' };

type BotBase_PublicBot_Fragment = { __typename?: 'PublicBot', id: number, name: string, short_description: string, image_url?: string | null, type: BotType, is_published: boolean, is_preview: boolean, is_deterministic: boolean } & { ' $fragmentName'?: 'BotBase_PublicBot_Fragment' };
...
export type BotFragment = { __typename?: 'Bot', id: number, name: string, short_description: string, image_url?: string | null, type: BotType, webhook_url: string, webhook_secret: string, description?: string | null, homepage?: string | null, is_published: boolean, is_preview: boolean, is_deterministic: boolean } & { ' $fragmentName'?: 'BotFragment' };
