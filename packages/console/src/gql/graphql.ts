...
export type TaskQuery = { __typename?: 'Query', task: (
    { __typename?: 'Task', id: number, log: any }
    & { ' $fragmentRefs'?: { 'TaskFragment': TaskFragment } }
  ) };
...
export type UserQueryFragment = { __typename?: 'Query', user?: (
    ...
    & { ' $fragmentRefs'?: { 'UserAvatarFragment': UserAvatarFragment } }
  ) | null } & { ' $fragmentName'?: 'UserQueryFragment' };
...
export type AppQuery = { __typename?: 'Query', app: { __typename?: 'App', cloud: boolean, client_uri: string, webhook_uri: string, integrations: { __typename?: 'AppIntegrations', github: boolean, gitlab: boolean, linear: boolean, jira: boolean, slack: boolean } }, user?: { __typename?: 'User', id: number, email: string } | null };
