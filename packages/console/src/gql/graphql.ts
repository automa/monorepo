...
export type OrgsQueryFragmentFragment = { __typename?: 'Query', orgs: Array<{ __typename?: 'Org', id: number, name: string, provider_type: ProviderType, provider_id: string, provider_name: string, has_installation: boolean, bot_installations_count: number }> } & { ' $fragmentName'?: 'OrgsQueryFragmentFragment' };
