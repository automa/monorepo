...
>(({ $error, disabled }) => [
  'w-full rounded-md bg-neutral-100 p-2 ring-1 ring-neutral-500 placeholder:text-neutral-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-neutral-500',
  $error && 'ring-red-500',
