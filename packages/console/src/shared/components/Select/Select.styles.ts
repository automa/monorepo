...
>(({ $error, disabled }) => [
  'w-80 rounded-md bg-neutral-100 p-2 ring-1 ring-neutral-500 data-[placeholder]:text-neutral-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-neutral-500 lg:w-96',
  $error && 'ring-red-500',
...
export const Item = tw(Select.Item)(({ disabled }) => [
  'flex h-8 cursor-pointer select-none items-center rounded-md px-3 text-neutral-700 data-[highlighted]:bg-neutral-200 data-[state="checked"]:bg-neutral-200 data-[highlighted]:text-black data-[state="checked"]:text-black data-[highlighted]:outline-none',
