...
export const Control = tw.input<TwcComponentProps<'input'> & InputStyledProps>(
  ({ $error, disabled }) => [
    'w-80 rounded-md bg-neutral-100 p-2 ring-1 ring-neutral-500 placeholder:text-neutral-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-neutral-500 lg:w-96',
    $error && 'ring-red-500',
