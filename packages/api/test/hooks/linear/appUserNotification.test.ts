    ...
    suite('create in comment thread', () => {
      setup(async () => {
        response = await callWithFixture(
          app,
          'AppUserNotification',
          'issueCommentMention/create_with_parent',
        );
      });
    ...
    suite('create with no bot specified', () => {
      setup(async () => {
        response = await callWithFixture(
          app,
          'AppUserNotification',
          'issueCommentMention/create_no_bot',
        );
      });
    ...
    suite('create with wrong bot specified', () => {
      setup(async () => {
        response = await callWithFixture(
          app,
          'AppUserNotification',
          'issueCommentMention/create_bot_bad',
        );
      });
    ...
    suite('create with no repo specified', () => {
      setup(async () => {
        response = await callWithFixture(
          app,
          'AppUserNotification',
          'issueCommentMention/create_no_repo',
        );
      });
    ...
    suite('create with wrong repo specified', () => {
      setup(async () => {
        response = await callWithFixture(
          app,
          'AppUserNotification',
          'issueCommentMention/create_repo_bad',
        );
      });
    ...
    suite('create with no bot and no repo specified', () => {
      setup(async () => {
        response = await callWithFixture(
          app,
          'AppUserNotification',
          'issueCommentMention/create_no_bot_repo',
        );
      });
    ...
    suite('create with non-automa comment', () => {
      setup(async () => {
        response = await callWithFixture(
          app,
          'AppUserNotification',
          'issueCommentMention/create_ignore',
        );
      });
